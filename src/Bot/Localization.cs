...
public static class Localization
{
    ...
    private static readonly Dictionary<string, string> defaultLocalization = new Dictionary<string, string>
    {
        ...
        { "disc_precond_guild_only", "This command can only be used inside a Discord server." },
        { "disc_precond_bot_priv", "You must be the server owner, have Administrator permission, or have a configured privileged role to use this command." },
